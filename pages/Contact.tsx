  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-20">
      <div className="grid lg:grid-cols-2 gap-16">
        ...
        >
          <h1 className="text-5xl font-bold text-slate-900 mb-8 font-tamil">{t('contact_us')}</h1>
          ...
          <div className="space-y-10">
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <p className="text-slate-600">+91 44 2345 6789</p>
              </div>
            </div>
        ...
        >
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            <div className="space-y-2">
              <label className="text-sm font-bold text-slate-700 uppercase tracking-wider">{t('name')}</label>
              <input 
                type="text" 
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-slate-700 uppercase tracking-wider">{t('message')}</label>
              <textarea 
                rows={4}
                className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#800000]/20 focus:border-[#800000] transition-all"
