...
const Home: React.FC = () => {
  ...
  const galleryItems = [
    {
      url: "https://generativelanguageyid.googleapis.com/v1beta/files/sc-9c2f66be4e34159f8c6d1236166e5113-1740058763079",
      title: "மனத்தோடு மாங்கல்யம்",
      subtitle: "Traditional Values"
    },
    {
      url: "https://generativelanguageyid.googleapis.com/v1beta/files/sc-9c2f66be4e34159f8c6d1236166e5113-1740058763889",
      title: "நிர்வாகி",
      subtitle: "Office Administration"
    },
    {
      url: "https://generativelanguageyid.googleapis.com/v1beta/files/sc-9c2f66be4e34159f8c6d1236166e5113-1740058764047",
    ...
    <div className="overflow-hidden bg-white">
      ...
      <section className="relative py-20 lg:py-32 px-4 bg-gradient-to-b from-white to-slate-50 border-b border-slate-100">
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          >
            <div className="w-24 h-24 bg-white shadow-2xl rounded-3xl flex items-center justify-center mx-auto mb-6 transform -rotate-12 border border-slate-100 ring-8 ring-maroon-50">
               <span className="text-4xl text-[#800000]">ॐ</span>
            </div>
          </motion.div>
          ...
          >
             ...
             <Link to="/signup" className="w-full sm:w-auto px-8 py-4 border-2 border-[#800000] text-[#800000] font-bold rounded-2xl hover:bg-[#800000] hover:text-white transition-all">
                {t('nav_signup')}
             </Link>
          </motion.div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-20 lg:py-32">
        <div className="mb-20 text-center">
            <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 font-tamil mb-6 tracking-tight">உறுப்பினர் தேடல் / Member Search</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
          ...
          <motion.div
            ...
            className="group"
          >
            <Link to="/mappillai" className="block relative h-[550px] lg:h-[700px] rounded-[3rem] overflow-hidden shadow-2xl group border-8 border-white">
              <img 
              ...
              <div className="absolute bottom-0 left-0 p-10 lg:p-16 w-full text-white">
                <div className="text-4xl lg:text-6xl font-bold mb-6 font-tamil drop-shadow-2xl uppercase">{t('groom_title')}</div>
          ...
          <motion.div
            ...
            className="group"
          >
            <Link to="/penn" className="block relative h-[550px] lg:h-[700px] rounded-[3rem] overflow-hidden shadow-2xl group border-8 border-white">
              <img 
                src="https://images.unsplash.com/photo-1621112904887-419379ce6824?auto=format&fit=crop&q=80&w=800" 
                alt="Bride"
                className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent opacity-80" />
              <div className="absolute bottom-0 left-0 p-10 lg:p-16 w-full text-white">
                <div className="text-4xl lg:text-6xl font-bold mb-6 font-tamil drop-shadow-2xl uppercase">{t('bride_title')}</div>
                <div className="flex items-center gap-4 text-xl lg:text-2xl font-bold opacity-90 group-hover:gap-6 transition-all uppercase tracking-widest">
      ...
      <section className="bg-slate-50 py-24 lg:py-32 border-y border-slate-100 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-20 text-center">
            <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 font-tamil mb-6">பாரம்பரியம் / Our Legacy</h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-lg">Trusted by generations, serving the community with honor.</p>
          </div>
            ...
            {galleryItems.map((item, idx) => (
              ...
              >
                ...
                <div className="p-10 bg-white text-center border-t border-slate-50 relative">
                  ...
                  <div className="text-2xl font-black text-slate-900 font-tamil mb-2 group-hover:text-[#800000] transition-colors uppercase">{item.title}</div>
                  <div className="text-sm font-bold text-slate-400 uppercase tracking-[0.2em]">{item.subtitle}</div>
                </div>
              </motion.div>
            ))}
          </motion.div>
