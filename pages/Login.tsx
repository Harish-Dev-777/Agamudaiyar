      ...
      <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-100 p-8 lg:p-12">
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-slate-500 text-sm">
            {t("login_sub")}{" "}
            <Link to="/signup" className="text-[#800000] font-bold">
              {t("register_now")}
            </Link>
          </p>
        </div>
        ...
        >
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <button
                ...
                className="text-xs text-[#800000] font-bold uppercase"
              >
                {t("show_password")}
              </button>
            </div>
          ...
          <button
            type="submit"
            className="w-full py-4 bg-[#800000] text-white rounded-2xl font-bold text-lg shadow-lg hover:bg-maroon-900 transition-all"
          >
            {t("sign_in")}
          </button>
          ...
          <div className="text-center space-y-4">
            <Link
              ...
              className="text-sm text-slate-500 hover:text-[#800000] font-medium"
            >
              {t("forgot_password")}
            </Link>
            <div className="pt-4 border-t border-slate-50">
              <Link
                to="/admin/login"
                className="text-xs text-slate-400 hover:text-[#800000] font-bold uppercase tracking-widest"
              >
                {t("admin_login")}
              </Link>
            </div>
        ...
        <div className="mt-12 text-center text-[10px] text-slate-400 uppercase tracking-widest border-t pt-8">
          Copyright © 2023 AGAMUDAIYAR. All rights reserved.
          <br />
